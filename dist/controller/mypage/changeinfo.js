...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (bcryptjs_1.compareSync(password, user.password)) {
        newPass ? (password = bcryptjs_1.default.hashSync(newPass, 12)) : (password = user.password);
        let { username } = user;
        newUserName ? (username = newUserName) : null;
        const infoData = { username, password };
        const result = yield User_1.default.changeInfo(id, infoData);
        if (result) {
...
//# sourceMappingURL=changeinfo.js.map